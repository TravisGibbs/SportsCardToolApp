...
1. Ensure all temp files are removed and to create tests for new features prior to pull request
2. Write a clear explination of how changes improve website in terms of accessibility, function, or apearance.
